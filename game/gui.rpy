...
define gui.accent_color = '#ffdb00'
...
define gui.text_font = gui.preference("font", "gui/fonts/NotoSans-Regular.ttf")

## The font used for character names.
define gui.name_text_font = "gui/fonts/NotoSans-Regular.ttf"
...
elif renpy.variant("small") or renpy.variant("mobile"):
  define gui.text_size = gui.preference("size", 10)
...
define gui.navigation_button_text_selected_color = gui.accent_color
...
define gui.choice_button_text_hover_color = "#ffdb00"
...
init python:
    ...
    if renpy.variant("small") or renpy.variant("mobile"):
        ...
        ## Font sizes.
        gui.text_size = gui.preference("size", 30)
